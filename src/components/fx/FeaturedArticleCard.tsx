...
export function FeaturedArticleCard({ article }: { article: Article }) {
  ...
  return (
    <Link
      ...
      className="group relative block cursor-pointer overflow-hidden rounded-3xl bg-gradient-to-br from-navy-950 via-navy-900 to-navy-700 p-7 text-white shadow-card transition-shadow duration-200 hover:shadow-card-hover md:p-10"
    >
