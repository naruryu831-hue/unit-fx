...
本記事で紹介した業者の中では、[みんなのFX](/articles/minna-fx-review)を運営するトレイダーズ証券が「みんなのシストレ」というストラテジー選択型のサービスを併設しています。[外為どっとコム](/articles/gaitame-review)や[松井証券](/articles/matsui-fx-review)でも、リピート系の自動売買機能が取引ツールに組み込まれている場合があります。具体的な機能や対応通貨ペアは各社で異なるため、公式サイトでご確認ください。
...
・自動売買であっても[証拠金維持率](/articles/fx-shoukokin-ijiritsu)は変動するため、ロスカット水準やアラート機能の有無を確認したか
...
必要証拠金の目安やレバレッジごとのシミュレーションは、本サイトの[計算ツール](/tools)でも試算できます。複数ポジションを想定した資金計画を立てる際の参考にしてください。

■ まとめ

国内FXの自動売買には、値幅を設定して注文を自動的に繰り返すリピート系と、既存のストラテジーを選んで運用するシストレ型があります。いずれも感情に左右されない機械的な取引ができる一方、想定した値幅を超える相場の動きや、過去の実績が将来を保証しない点には注意が必要です。自動売買を利用する場合も、証拠金維持率の定期的な確認と、無理のない資金管理を心がけてください。国内FX業者全体の比較は[国内FX業者比較まとめ](/articles/kokunai-fx-hikaku-hub)もあわせてご覧ください。`,
  relatedSlugs: [
