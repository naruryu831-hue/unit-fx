...
・[HFM（HotForex）](/articles/hfm-review)：2010年設立。複数の金融ライセンスのもとでFX・貴金属・株価指数などを扱い、日本語のライブチャット・メールサポートあり
・[AXIORY（アキシオリー）](/articles/axiory-review)：2011年設立、ベリーズ拠点のAxiory Global Ltd.が運営。MT4／MT5／cTraderに対応し、日本語カスタマーサポートあり
...
・その最大倍率が自分の開設する口座タイプに適用されるかを必ず確認する。[TitanFX](/articles/titanfx-review)や[FXGT](/articles/fxgt-review)のように口座タイプで倍率が変わる例が多い
...
比較の実務としては、候補を2社程度に絞り、それぞれの公式サイトで自分が開設する口座タイプの最大レバレッジを確認してから決めるのが確実です。他の[海外FX業者と比較](/articles/kaigai-fx-hikaku-hub)したい場合はこちらも参考にしてください。`,
  faq: [
    {
