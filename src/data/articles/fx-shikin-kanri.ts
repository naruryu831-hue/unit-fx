...
export const fxShikinKanri: Article = {
  ...
  body: `FXで長く取引を続けていくうえで、テクニカル分析やファンダメンタルズ分析と同じくらい重要とされているのが資金管理です。どれだけ精度の高い分析ができても、1回の取引で許容範囲を超える損失を出してしまうと、資金全体に大きなダメージが及ぶ可能性があります。この記事では、FXの資金管理の基本的な考え方と、1回の許容損失・取引数量の決め方について解説します。
