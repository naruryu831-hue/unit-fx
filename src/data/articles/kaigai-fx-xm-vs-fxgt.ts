...
[XM](/articles/xm-review)は2009年設立で、日本人トレーダーへの知名度が最も高い海外FX業者のひとつとされています。日本語サポートに対応しています。[FXGT](/articles/fxgt-review)（運営会社GT Global Ltd）は2019年にサービスを開始した比較的新しい業者で、セーシェル金融庁のライセンスの下、FXに加えて暗号資産CFDも扱っている点が特徴です。運営実績の長さで見るとXMが先行していますが、FXGTは複数商品を一つの口座で扱える点で異なる立ち位置にあります。

■ 2. 最大レバレッジの違い

XMの[最大レバレッジ](/articles/kaigai-fx-high-leverage-hikaku)は1000倍です。数値がはっきりと公式サイトに明記されており、条件が分かりやすい点が特徴です。FXGTは[口座タイプ](/articles/kaigai-fx-kouza-type-hikaku)によって異なり、通常口座は最大1000倍、Optimus口座では一定の取引条件を満たした場合に最大5000倍まで利用できるとされています。数値の上限だけを見るとFXGTの方が高くなり得ますが、5000倍が適用されるのは特定の口座タイプ・条件を満たした場合に限られるため、常にその倍率が使えるわけではない点に注意が必要です。

■ 3. 最低入金額の違い

XMは[最低入金額](/articles/kaigai-fx-saitei-nyukin-hikaku)が5米ドル相当と公式サイトに明記されており、少額から口座を開設しやすい業者として案内されています。FXGTは口座タイプにより異なり、最低5〜10ドル程度とされています（Optimus口座は10ドル、その他口座は5ドル〜、日本円での銀行振込等は別途条件がある場合があります）。どちらも少額から始められる点は共通していますが、口座タイプごとに条件が変わるFXGTの方が、開設前に確認すべき項目がやや多いといえます。

■ 4. 取扱商品の違い

XMはFX・貴金属・株価指数・エネルギーなどのCFDを扱う総合的な業者です。FXGTはFXに加えて[暗号資産CFD](/articles/kaigai-fx-kasoutsuka-cfd)の取り扱いを前面に打ち出しており、一つの口座でFXと暗号資産の両方を取引したい人に向いている構成になっています。暗号資産CFDへの関心があるかどうかが、この2社を選ぶ際の分かりやすい判断材料の一つになります。
