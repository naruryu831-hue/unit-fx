...
export const jfxReview: Article = {
  ...
  body: `JFXは、ヒロセ通商グループのJFX株式会社が運営する国内FXサービスです。取引ツール「MATRIX TRADER」と、スキャルピングを公式に認めている点で知られています。国内FXは金融庁登録の第一種金融商品取引業者が提供するサービスであり、個人の最大レバレッジは25倍までと法律で定められています。本記事ではJFXの基本情報、向いている人・向かない人、口座開設の流れ、注意点をまとめて解説します。
