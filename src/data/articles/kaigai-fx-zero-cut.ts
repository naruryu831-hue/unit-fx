...
通常、FX取引ではロスカット（強制決済）の仕組みにより、[証拠金維持率](/articles/fx-shoukokin-ijiritsu)が一定水準を下回った時点で自動的にポジションが決済され、大きな損失を防ぐ設計になっています。しかし、指標発表や要人発言などによる急激な価格変動が起きると、注文が想定した価格で約定できず、ロスカットの水準を飛び越えて約定してしまうことがあります。この「スリッページ」が大きい場合、証拠金を超えるマイナス残高が発生する可能性があります。

■ 国内FXとの違い

国内FX業者では、[レバレッジ規制（個人の場合最大25倍）](/articles/fx-leverage-25bai-imi)に加えて、マイナス残高が発生した場合はトレーダーが不足分を追加で入金する「[追証](/articles/fx-losscut-kokunai)」が発生する仕組みが一般的です。相場急変時に想定外の損失を被り、証拠金を超える金額の支払いを求められるリスクがあります。一方、海外FX業者の多くは高いレバレッジを提供しつつゼロカットシステムを採用しているとされ、マイナス残高分は業者側が負担する運用になっている点が構造的な違いです。ただし、レバレッジが高いほど短時間の値動きによる損益の振れ幅も大きくなる点は変わらず、ゼロカットは「損失そのものをなくす」仕組みではありません。
...
・兼業トレーダーで相場を常時見られない人：指標発表など価格変動が大きくなりやすいタイミングの前後は、ポジションを持ったまま離席することでロスカットが想定と異なるタイミングで発動するリスクが高まる。[経済指標カレンダー](/articles/fx-keizai-shihyou-calendar)を確認し、重要指標の前後は取引を控える、またはポジションを軽くするなどの対応を検討する
...
必要証拠金やレバレッジごとの損益の振れ幅は、本サイトの[計算ツール](/tools)であらかじめ試算しておくと判断しやすくなります。
