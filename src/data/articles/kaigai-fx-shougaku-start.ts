...
さらに[口座開設ボーナス・入金ボーナス](/articles/kaigai-fx-kouza-bonus-matome)の案内もあるため、入金額を抑えたまま取引を試したい人に向いています。
...
[最大レバレッジ](/articles/kaigai-fx-high-leverage-hikaku)は通常口座で1:1000、Optimus口座で条件を満たした場合に1:5000。少額かつ高レバレッジで試したい人向けです。なお日本円での銀行振込等は別途条件があるため、入金方法ごとの条件も確認してください。
...
少ない資金で大きな取引量を扱いたい人が候補にしやすい一方、その分[ロスカット](/articles/kaigai-fx-losscut-suijun)までの余裕も小さくなります。少額で始めるほど、レバレッジ上限をそのまま使い切らない運用が前提になります。

■ 【要確認】BigBoss

2013年設立、セントビンセント・グレナディーン諸島を拠点とする業者。最大レバレッジは2222倍（口座タイプにより異なる）、日本語サポートあり。

[BigBoss](/articles/bigboss-review) Pointsや独自コインBigBoss Coin（BBC）建て入金時の10%相当クレジットボーナスなど、独自のプロモーションを実施しています。
...
[TitanFX](/articles/titanfx-review)は口座開設ボーナス・入金ボーナスは提供なしと公式サイトで明記されており、紹介プログラム等の特典が案内されています。

ボーナスによる上乗せではなく取引条件そのもので選びたい人向けの業者です。

■ 【要確認】HFM（HotForex）

2010年設立。[HFM](/articles/hfm-review)は複数の金融ライセンスのもとで、FX・貴金属・株価指数などのオンライン取引サービスを提供しています。日本語のライブチャット・メールサポートあり。
