...
export const hfmAccountOpening: Article = {
  ...
  body: `本記事では、[HFM(HotForex)](/articles/hfm-review)の公式サイトで口座を開設し、本人確認を済ませてMT4/MT5で取引を始めるまでの手順を、実際の流れに沿って解説します。書類が手元にそろっていれば、登録フォームの入力そのものは10〜15分程度で終わり、あとは本人確認の審査を待つだけです。この記事を開いたまま、別のタブで公式サイトを開いて進めてください。

なお、HFMは日本の金融庁に登録されていない[海外FX業者](/kaigai)です。国内FX業者とは規制環境が異なり、相場の急変によっては預けた資金を上回る損失が生じる可能性もあります。その点を理解したうえで手続きを進めてください。他の海外FX業者と比較したい場合は[海外FX比較](/articles/kaigai-fx-hikaku-hub)も参考にしてください。
...
HFM(HotForex)の口座開設は、新規登録、メール認証、取引口座の作成、本人確認書類の提出、入金という流れで進みます。手続きの大半はオンラインで完結しますが、書類の不備があると審査でやり直しになるため、入力内容と書類の記載を一致させることが最大のポイントです。レバレッジや最低入金額といった条件は口座タイプや登録法人によって変わるため、申し込みの直前に公式サイトの最新情報を確認してください。入金まで終わったら、次は[MT4/MT5の使い方ガイド](/articles/mt4-mt5-guide)で取引画面の操作を確認しておきましょう。`,
  faq: [
    {
