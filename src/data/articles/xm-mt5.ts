...
export const xmMt5: Article = {
  ...
  body: `[XM(XM Trading)](/articles/xm-review)ではMT4に加えてMT5(MetaTrader 5)にも対応しており、パソコン・ブラウザ・スマートフォンアプリなど複数の形態で利用できます。本記事ではXMでMT5を使い始めるための基本的な流れを整理します。実際の画面表示や操作手順は端末やバージョンによって異なる場合があるため、詳細は公式サイト（https://www.xmtrading.com/）のダウンロードページや取引プラットフォームの案内を確認してください。海外業者は日本の金融庁に未登録で、元本を超える損失が生じる可能性がある点も踏まえたうえで取引を行う必要があります。

■ MT5とは何か

MT5(MetaTrader 5)はMT4の後継として提供されている取引プラットフォームで、チャート分析や自動売買(EA)、複数の時間足の同時表示など、取引に必要な機能が備わっています。基本的な操作方法は[MT4/MT5の使い方ガイド](/articles/mt4-mt5-guide)でも解説しています。XMではMT4・MT5のどちらかを選んで利用でき、口座タイプによって対応状況が異なる場合があるため、口座開設時にどちらのプラットフォームを使うか選択することになります。
...
1. [XMの口座開設](/articles/xm-account-opening)完了後に届く、口座番号・パスワード・サーバー名などのログイン情報を確認する
...
・少額資金で取引する人：ロット数を誤ると証拠金に対する損益の割合が大きくなりやすいため、注文画面でロット数を入力するたびに[証拠金維持率](/articles/kaigai-fx-losscut-suijun)がどう変化するかを毎回確認する習慣をつけておくと過大なポジションを避けやすい
...
・口座タイプによってMT4/MT5のどちらか一方にしか対応していない場合があるため、利用したい[口座タイプ](/articles/xm-kouza-type)の対応プラットフォームを公式サイトの口座タイプ比較ページで確認してから選ぶ
...
XMではMT5をデスクトップ・ブラウザ・スマートフォンアプリのいずれの形態でも利用でき、口座開設後のログイン情報を使って比較的簡単に取引を始められます。ただし具体的な操作画面や対応状況はバージョンや口座タイプによって異なる場合があるため、詳しい手順は公式サイト(https://www.xmtrading.com/)のダウンロードページやサポート情報で確認してください。海外業者は日本の金融庁に未登録で、元本を超える損失が生じる可能性があることを理解したうえで、注文前には損切りラインの設定など基本的な資金管理を心がけることが大切です。他の海外FX業者と比較したい場合は[海外FX比較](/articles/kaigai-fx-hikaku-hub)も参考にしてください。`,
  summaryPoints: [
