...
export const kaigaiFxJuminzeiFutsuChoshu: Article = {
  ...
  body: `会社員が副業として海外FXに取り組む場合、「会社に知られたくない」という相談が多く寄せられます。これは脱税や申告漏れの話ではなく、住民税の徴収方法の選び方に関する、正当な手続き上の話です。この記事では、住民税の特別徴収と普通徴収の違いと、確定申告時にどちらを選べるのかを整理します。海外業者は日本の金融庁に登録されておらず、元本を超える損失が生じる可能性がある点も踏まえたうえで読み進めてください。
