...
export const kaigaiFxKakuteiShinkokuYarikata: Article = {
  ...
  body: `海外FXの利益は雑所得として総合課税の対象になり、給与所得などと合算した金額に累進税率（所得税5%〜45%＋住民税約10%）が適用されます。国内FXのような申告分離課税（一律20.315%）とは仕組みが違うため、申告の準備の仕方も変わってきます。この記事では、確定申告に必要な書類の集め方から申告書の作成手順までを順に整理します。なお、海外業者は日本の金融庁に登録されておらず、元本を超える損失が生じる可能性がある点にも留意してください。
