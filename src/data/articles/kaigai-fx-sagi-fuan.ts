...
・本サイトで扱う[海外FX業者](/kaigai)は、日本の金融庁の登録・認可を受けた国内FX業者ではありません。トラブル時に金融ADR（裁判外紛争解決手続き）など日本の公的な紛争解決制度の対象にはならず、窓口は拠点国のライセンス当局になります
・[レバレッジ上限](/articles/kaigai-fx-high-leverage-hikaku)は業者ごとの独自設定で、国内の25倍規制より高いことが一般的です。その分、価格変動時の損益の振れ幅も大きくなります
・多くの業者は[ゼロカットシステム](/articles/kaigai-fx-zero-cut)を採用しているとされますが、適用条件は各社の規約次第です。相場急変時に投じた資金を超える損失が生じ得る取引である点は変わりません
...
[出金トラブル](/articles/kaigai-fx-shukkin-kyohi)には、正当な理由に基づく保留と、業者側の不誠実な対応の両方があるため、切り分けて理解する必要があります。
...
・[スプレッドの拡大](/articles/kaigai-fx-spread-hikaku)：指標発表時や流動性の低い時間帯に拡大するのは、多くの業者で規約上想定された仕様であり詐欺ではありません。ただし常時異常に広い、事前の説明と実態が大きく乖離しているといった場合は、信頼性を疑う材料になり得ます
・スリッページ・約定拒否（リクオート）：注文価格と約定価格のずれは相場急変時に起こり得る一般的な現象です。NDD方式の業者ではインターバンク市場の実勢価格に基づいて約定するため、有利・不利どちらの方向にも生じます。単独では詐欺の証拠になりません
・ロスカット・強制決済：[証拠金維持率](/articles/kaigai-fx-losscut-suijun)が一定水準を下回った際の自動決済は、多くの業者で規約に明記されています。「ロスカットされた＝詐欺」ではなく、自分の口座のロスカット水準を事前に把握しておくことがトラブル回避につながります
